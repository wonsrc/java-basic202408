...
public class HashMapExample {
    public static void main(String[] args) {
        ...
        // Key 존재 유무를 확인하는 메서드: containsKey(key)
        ...
        //  모든 Key 들을 Set에 담아서 반환합니다 -> ForEach 사용이 가능해짐.
        ...
        // Collections 메서드는 Collection 인터페이스 타입을 전달받기 때문에
        // Map 은 사용이 힘듭니다.
