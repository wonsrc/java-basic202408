...
//        String name = nick[3];
        ...
        System.out.println(nick);
        System.out.println(nick.get(3).hashCode());
        System.out.println(nick.get(5).hashCode());
        ...
        List<Integer> score = new ArrayList<>(); // 제네릭은 객체, 참조 타입만 진행
...
//        // 내림차 정렬
//        Collections.reverse(score); // 단순 역순 배치
