...
public class FileOutputExample {
    ...
    public static void main(String[] args) {
        ...
        // 메모리 자원 반납 처리를 자동화 해주는 문법. (1.8 부터 가능)
        // close 하려는 객체가 AutoCloseable 인터페이스의 구현체여야 합니다.

//        FileOutputStream fos = null;
        try (FileOutputStream fos
                     = new FileOutputStream(FileExample.ROOT_PATH+"\\upload\\hello.txt")){
//           fos = new FileOutputStream(FileExample.ROOT_PATH+"\\upload\\hello.txt");
